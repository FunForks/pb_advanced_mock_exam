...
/* A-2 */
function createNestedArrayFromObject() {}


/* B-1 */
const scrambleWords = null;


/* B-2 */
function convertNestedArrayToObject() {};


/* B-3 */
const makeGameGrid = null;


/* B-4 */
const generateAverages = null;
